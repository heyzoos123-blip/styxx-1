...
offs.clear(); loop(3)
print(sys.version.split()[0], 'after settrace(None): instruction offsets seen', sorted(set(offs)))
M.restart_events(); offs.clear(); loop(3)
print(sys.version.split()[0], 'after restart_events(): instruction offsets seen', sorted(set(offs)))
