# Revision 8: rev7/w7_greenlet.py run on rev8/mech8.py. Revision 7 (N5): X137f exactly as the case text states it, on greenlet 3.5.6 (rev6/site312, rev6/site313):
