"""Protocol v5 round-2 exam, per PREREG_protocol_v5c_repair_2026_09_24.md.
...
PREREG = "PREREG_protocol_v5c_repair_2026_09_24.md"
...
def violations() -> dict:
    ...
    def out_of_order(tmp):
        ...
        try:
            ...
            if sys.getprofile() is not before:
...
def main() -> int:
    fixdir = Path(tempfile.mkdtemp(prefix="v5cfix_"))
    ...
    attempt_b.OWN_PREREGS.add(PREREG)
    ...
    (HERE / f"protocol_v5c_result{'_smoke' if SMOKE else ''}.json").write_text(
