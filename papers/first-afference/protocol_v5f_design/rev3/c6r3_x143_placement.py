# Revision 3: critic3/c6_x143_inside_selftrace.py run unchanged against mech3.py (rev 3: _commit inside _run's try).
# X143 moves to the main thread before the self-trace (MF3); this shows it still witnesses the second _unwind_on().
