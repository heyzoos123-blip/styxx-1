...
# Output: wide_claims_post.json, one record per sentence that contains a wide keyword; 'old' marks sentences that also
...
json.dump(out, open('wide_claims_post.json', 'w'), indent=0, ensure_ascii=False)
