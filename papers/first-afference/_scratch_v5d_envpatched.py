...
import os as _os
if _os.environ.get("STYXX_V5_IMPORT_ROOT"):
    sys.path.insert(0, _os.environ["STYXX_V5_IMPORT_ROOT"])
...
def main() -> int:
    ...
    (Path(_os.environ["STYXX_V5_RESULT_OUT"]) if _os.environ.get("STYXX_V5_RESULT_OUT") else HERE / f"protocol_v5d_result{'_smoke' if SMOKE else ''}.json").write_text(
