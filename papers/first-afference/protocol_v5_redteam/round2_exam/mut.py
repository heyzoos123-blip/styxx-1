...
R = "/tmp/claude-0/-home-user/1230efe6-3e44-5eb6-ad91-35910fea5db9/scratchpad/rt4/repo"
P = f"{R}/styxx/protocol.py"
OUT = "/tmp/claude-0/-home-user/1230efe6-3e44-5eb6-ad91-35910fea5db9/scratchpad/rt4/out"
...
for name, reps in MUTANTS.items():
    ...
    try:
        try:
            p = subprocess.run([sys.executable, "papers/first-afference/run_protocol_v5c.py", "--smoke", "--full-battery"],
